...
extends EntityMap {
    ...
    public void rewriteClientbound(ByteBuf packet, int oldId, int newId) {
        ...
        switch (packetId) {
            case 58: {
                EntityMap_1_10.rewriteInt((ByteBuf)packet, (int)oldId, (int)newId, (int)(readerIndex + packetIdLength + 4));
                break;
            }
            case 72: {
                DefinedPacket.readVarInt((ByteBuf)packet);
                EntityMap_1_10.rewriteVarInt((ByteBuf)packet, (int)oldId, (int)newId, (int)packet.readerIndex());
                break;
            }
            case 64: {
                DefinedPacket.readVarInt((ByteBuf)packet);
            ...
            case 44: {
                ...
                if (event == 1) {
                    DefinedPacket.readVarInt((ByteBuf)packet);
                    EntityMap_1_10.rewriteInt((ByteBuf)packet, (int)oldId, (int)newId, (int)packet.readerIndex());
                    break;
                }
                if (event != 2) break;
                int position = packet.readerIndex();
            ...
            case 57: {
                DefinedPacket.readVarInt((ByteBuf)packet);
                EntityMap_1_10.rewriteMetaVarInt((ByteBuf)packet, (int)(oldId + 1), (int)(newId + 1), (int)6);
            }
        }
        packet.readerIndex((int)readerIndex);
    }
