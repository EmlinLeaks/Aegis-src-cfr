...
Externalizable {
    ...
    @Override
    public int hashCode() {
        HashProcedure p = new HashProcedure((THashSet)this, null);
        this.forEach(p);
    ...
    protected void rehash(int newCapacity) {
        ...
        do {
            if (i-- <= 0) {
                THashSet.reportPotentialConcurrentMod((int)this.size(), (int)oldSize);
                return;
            }
            Object o = oldSet[i];
    ...
    public String toString() {
        ...
        this.forEach(new TObjectProcedure<E>((THashSet)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ THashSet this$0;
            {
                this.this$0 = this$0;
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        this.writeEntries((ObjectOutput)out);
    }
