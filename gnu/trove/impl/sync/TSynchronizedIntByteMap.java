...
Serializable {
    ...
    public byte put(int key, byte value) {
        ...
        // MONITORENTER : object
        // MONITOREXIT : object
        return this.m.put((int)key, (byte)value);
    }
    ...
    public byte putIfAbsent(int key, byte value) {
        ...
        // MONITORENTER : object
        // MONITOREXIT : object
        return this.m.putIfAbsent((int)key, (byte)value);
    }
    ...
    public boolean retainEntries(TIntByteProcedure procedure) {
        ...
        // MONITORENTER : object
        // MONITOREXIT : object
        return this.m.retainEntries((TIntByteProcedure)procedure);
    }
    ...
    public boolean adjustValue(int key, byte amount) {
        ...
        // MONITORENTER : object
        // MONITOREXIT : object
        return this.m.adjustValue((int)key, (byte)amount);
    }
    ...
    public byte adjustOrPutValue(int key, byte adjust_amount, byte put_amount) {
        ...
        // MONITORENTER : object
        // MONITOREXIT : object
        return this.m.adjustOrPutValue((int)key, (byte)adjust_amount, (byte)put_amount);
    }
