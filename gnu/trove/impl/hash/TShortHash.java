...
extends TPrimitiveHash {
    ...
    protected int index(short val) {
        ...
        if (state != 1) return this.indexRehashed((short)val, (int)index, (int)hash, (byte)state);
        if (set[index] != val) return this.indexRehashed((short)val, (int)index, (int)hash, (byte)state);
        return index;
    }
