...
Cloneable {
    ...
    public Double put(Long key, Double value) {
        ...
        double retval = this._map.put((long)k, (double)v);
    ...
    public Double remove(Object key) {
        ...
        double v = this._map.remove((long)k);
        if (v != this._map.getNoEntryValue()) return this.wrapValue((double)v);
        return null;
    }
    ...
    public Set<Map.Entry<Long, Double>> entrySet() {
        return new AbstractSet<Map.Entry<Long, Double>>((TLongDoubleMapDecorator)this){
            final /* synthetic */ TLongDoubleMapDecorator this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public Iterator<Map.Entry<Long, Double>> iterator() {
                return new Iterator<Map.Entry<Long, Double>>(this){
                    ...
                    public Map.Entry<Long, Double> next() {
                        ...
                        return new Map.Entry<Long, Double>(this, (Double)v, (Long)key){
                            private Double val;
                            ...
                            public Double setValue(Double value) {
                                this.val = value;
                                return this.this$2.this$1.this$0.put((Long)this.val$key, (Double)value);
                            }
                        };
                    }
            ...
            public boolean addAll(java.util.Collection<? extends Map.Entry<Long, Double>> c) {
                throw new java.lang.UnsupportedOperationException();
            }
