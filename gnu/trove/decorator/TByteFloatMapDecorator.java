...
Cloneable {
    ...
    public Float put(Byte key, Float value) {
        ...
        float retval = this._map.put((byte)k, (float)v);
    ...
    public Float remove(Object key) {
        ...
        float v = this._map.remove((byte)k);
        if (v != this._map.getNoEntryValue()) return this.wrapValue((float)v);
        return null;
    }
    ...
    public Set<Map.Entry<Byte, Float>> entrySet() {
        return new AbstractSet<Map.Entry<Byte, Float>>((TByteFloatMapDecorator)this){
            final /* synthetic */ TByteFloatMapDecorator this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public Iterator<Map.Entry<Byte, Float>> iterator() {
                return new Iterator<Map.Entry<Byte, Float>>(this){
                    ...
                    public Map.Entry<Byte, Float> next() {
                        ...
                        return new Map.Entry<Byte, Float>(this, (Float)v, (Byte)key){
                            private Float val;
                            ...
                            public Float setValue(Float value) {
                                this.val = value;
                                return this.this$2.this$1.this$0.put((Byte)this.val$key, (Float)value);
                            }
                        };
                    }
            ...
            public boolean addAll(java.util.Collection<? extends Map.Entry<Byte, Float>> c) {
                throw new java.lang.UnsupportedOperationException();
            }
