...
Cloneable {
    ...
    public Long put(Short key, Long value) {
        ...
        long retval = this._map.put((short)k, (long)v);
    ...
    public Long remove(Object key) {
        ...
        long v = this._map.remove((short)k);
        if (v != this._map.getNoEntryValue()) return this.wrapValue((long)v);
        return null;
    }
    ...
    public Set<Map.Entry<Short, Long>> entrySet() {
        return new AbstractSet<Map.Entry<Short, Long>>((TShortLongMapDecorator)this){
            final /* synthetic */ TShortLongMapDecorator this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public Iterator<Map.Entry<Short, Long>> iterator() {
                return new Iterator<Map.Entry<Short, Long>>(this){
                    ...
                    public Map.Entry<Short, Long> next() {
                        ...
                        return new Map.Entry<Short, Long>(this, (Long)v, (Short)key){
                            private Long val;
                            ...
                            public Long setValue(Long value) {
                                this.val = value;
                                return this.this$2.this$1.this$0.put((Short)this.val$key, (Long)value);
                            }
                        };
                    }
            ...
            public boolean addAll(java.util.Collection<? extends Map.Entry<Short, Long>> c) {
                throw new java.lang.UnsupportedOperationException();
            }
