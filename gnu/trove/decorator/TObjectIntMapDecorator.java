...
Cloneable {
    ...
    public Integer put(K key, Integer value) {
        if (value != null) return this.wrapValue((int)this._map.put(key, (int)this.unwrapValue((Object)value)));
        return this.wrapValue((int)this._map.put(key, (int)this._map.getNoEntryValue()));
    }

    @Override
    public Integer get(Object key) {
        int v = this._map.get((Object)key);
    ...
    public Integer remove(Object key) {
        int v = this._map.remove((Object)key);
        if (v != this._map.getNoEntryValue()) return this.wrapValue((int)v);
        return null;
    }
    ...
    public Set<Map.Entry<K, Integer>> entrySet() {
        return new AbstractSet<Map.Entry<K, Integer>>((TObjectIntMapDecorator)this){
            final /* synthetic */ TObjectIntMapDecorator this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public Iterator<Map.Entry<K, Integer>> iterator() {
                return new Iterator<Map.Entry<K, Integer>>(this){
                    private final gnu.trove.iterator.TObjectIntIterator<K> it;
                    ...
                    public Map.Entry<K, Integer> next() {
                        this.it.advance();
                        K key = this.it.key();
                        Integer v = this.this$1.this$0.wrapValue((int)this.it.value());
                        return new Map.Entry<K, Integer>(this, (Integer)v, key){
                            private Integer val;
                            ...
                            public Integer setValue(Integer value) {
                                this.val = value;
                                return this.this$2.this$1.this$0.put(this.val$key, (Integer)value);
                            }
                        };
                    }
            ...
            public boolean addAll(java.util.Collection<? extends Map.Entry<K, Integer>> c) {
                throw new java.lang.UnsupportedOperationException();
            }
