...
Cloneable {
    ...
    public Float put(Float key, Float value) {
        ...
        float retval = this._map.put((float)k, (float)v);
    ...
    public Float remove(Object key) {
        ...
        float v = this._map.remove((float)k);
        if (v != this._map.getNoEntryValue()) return this.wrapValue((float)v);
        return null;
    }
    ...
    public Set<Map.Entry<Float, Float>> entrySet() {
        return new AbstractSet<Map.Entry<Float, Float>>((TFloatFloatMapDecorator)this){
            final /* synthetic */ TFloatFloatMapDecorator this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public Iterator<Map.Entry<Float, Float>> iterator() {
                return new Iterator<Map.Entry<Float, Float>>(this){
                    ...
                    public Map.Entry<Float, Float> next() {
                        ...
                        return new Map.Entry<Float, Float>(this, (Float)v, (Float)key){
                            private Float val;
                            ...
                            public Float setValue(Float value) {
                                this.val = value;
                                return this.this$2.this$1.this$0.put((Float)this.val$key, (Float)value);
                            }
                        };
                    }
            ...
            public boolean addAll(java.util.Collection<? extends Map.Entry<Float, Float>> c) {
                throw new java.lang.UnsupportedOperationException();
            }
