...
Externalizable {
    ...
    private final TObjectDoubleProcedure<K> PUT_ALL_PROC = new TObjectDoubleProcedure<K>((TObjectDoubleCustomHashMap)this){
        final /* synthetic */ TObjectDoubleCustomHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectDoubleCustomHashMap(HashingStrategy<? super K> strategy, TObjectDoubleMap<? extends K> map) {
        this(strategy, (int)map.size(), (float)0.5f, (double)map.getNoEntryValue());
        if (map instanceof TObjectDoubleCustomHashMap) {
            ...
            this.setUp((int)TObjectDoubleCustomHashMap.saturatedCast((long)TObjectDoubleCustomHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectDoubleCustomHashMap)this);
    }
    ...
    public TDoubleCollection valueCollection() {
        return new TDoubleValueCollection((TObjectDoubleCustomHashMap)this);
    }
    ...
    public TObjectDoubleIterator<K> iterator() {
        return new TObjectDoubleHashIterator<K>((TObjectDoubleCustomHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectDoubleProcedure<K>((TObjectDoubleCustomHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectDoubleCustomHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectDoubleCustomHashMap x0) {
        return x0._size;
    }
}
