...
Externalizable {
    ...
    private final TObjectIntProcedure<K> PUT_ALL_PROC = new TObjectIntProcedure<K>((TObjectIntCustomHashMap)this){
        final /* synthetic */ TObjectIntCustomHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectIntCustomHashMap(HashingStrategy<? super K> strategy, TObjectIntMap<? extends K> map) {
        this(strategy, (int)map.size(), (float)0.5f, (int)map.getNoEntryValue());
        if (map instanceof TObjectIntCustomHashMap) {
            ...
            this.setUp((int)TObjectIntCustomHashMap.saturatedCast((long)TObjectIntCustomHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectIntCustomHashMap)this);
    }
    ...
    public TIntCollection valueCollection() {
        return new TIntValueCollection((TObjectIntCustomHashMap)this);
    }
    ...
    public TObjectIntIterator<K> iterator() {
        return new TObjectIntHashIterator<K>((TObjectIntCustomHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectIntProcedure<K>((TObjectIntCustomHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectIntCustomHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectIntCustomHashMap x0) {
        return x0._size;
    }
}
