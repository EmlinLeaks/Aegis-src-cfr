...
Externalizable {
    ...
    private final TObjectByteProcedure<K> PUT_ALL_PROC = new TObjectByteProcedure<K>((TObjectByteCustomHashMap)this){
        final /* synthetic */ TObjectByteCustomHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectByteCustomHashMap(HashingStrategy<? super K> strategy, TObjectByteMap<? extends K> map) {
        this(strategy, (int)map.size(), (float)0.5f, (byte)map.getNoEntryValue());
        if (map instanceof TObjectByteCustomHashMap) {
            ...
            this.setUp((int)TObjectByteCustomHashMap.saturatedCast((long)TObjectByteCustomHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectByteCustomHashMap)this);
    }
    ...
    public TByteCollection valueCollection() {
        return new TByteValueCollection((TObjectByteCustomHashMap)this);
    }
    ...
    public TObjectByteIterator<K> iterator() {
        return new TObjectByteHashIterator<K>((TObjectByteCustomHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectByteProcedure<K>((TObjectByteCustomHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectByteCustomHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectByteCustomHashMap x0) {
        return x0._size;
    }
}
