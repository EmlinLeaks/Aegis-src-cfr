...
Externalizable {
    ...
    private final TObjectFloatProcedure<K> PUT_ALL_PROC = new TObjectFloatProcedure<K>((TObjectFloatCustomHashMap)this){
        final /* synthetic */ TObjectFloatCustomHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectFloatCustomHashMap(HashingStrategy<? super K> strategy, TObjectFloatMap<? extends K> map) {
        this(strategy, (int)map.size(), (float)0.5f, (float)map.getNoEntryValue());
        if (map instanceof TObjectFloatCustomHashMap) {
            ...
            this.setUp((int)TObjectFloatCustomHashMap.saturatedCast((long)TObjectFloatCustomHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectFloatCustomHashMap)this);
    }
    ...
    public TFloatCollection valueCollection() {
        return new TFloatValueCollection((TObjectFloatCustomHashMap)this);
    }
    ...
    public TObjectFloatIterator<K> iterator() {
        return new TObjectFloatHashIterator<K>((TObjectFloatCustomHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectFloatProcedure<K>((TObjectFloatCustomHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectFloatCustomHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectFloatCustomHashMap x0) {
        return x0._size;
    }
}
