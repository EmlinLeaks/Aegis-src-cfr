...
Externalizable {
    ...
    private final TObjectLongProcedure<K> PUT_ALL_PROC = new TObjectLongProcedure<K>((TObjectLongCustomHashMap)this){
        final /* synthetic */ TObjectLongCustomHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectLongCustomHashMap(HashingStrategy<? super K> strategy, TObjectLongMap<? extends K> map) {
        this(strategy, (int)map.size(), (float)0.5f, (long)map.getNoEntryValue());
        if (map instanceof TObjectLongCustomHashMap) {
            ...
            this.setUp((int)TObjectLongCustomHashMap.saturatedCast((long)TObjectLongCustomHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectLongCustomHashMap)this);
    }
    ...
    public TLongCollection valueCollection() {
        return new TLongValueCollection((TObjectLongCustomHashMap)this);
    }
    ...
    public TObjectLongIterator<K> iterator() {
        return new TObjectLongHashIterator<K>((TObjectLongCustomHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectLongProcedure<K>((TObjectLongCustomHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectLongCustomHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectLongCustomHashMap x0) {
        return x0._size;
    }
}
