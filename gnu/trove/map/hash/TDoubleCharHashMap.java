...
Externalizable {
    ...
    public TDoubleCharHashMap(int initialCapacity, float loadFactor, double noEntryKey, char noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (double)noEntryKey, (char)noEntryValue);
    }
    ...
    public TDoubleCharHashMap(double[] keys, char[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((double)keys[i], (char)values[i]);
            ++i;
        }
    }
    ...
    public TDoubleCharHashMap(TDoubleCharMap map) {
        ...
        if (map instanceof TDoubleCharHashMap) {
            ...
            this.setUp((int)TDoubleCharHashMap.saturatedCast((long)TDoubleCharHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TDoubleCharMap)map);
    }
    ...
    public char put(double key, char value) {
        ...
        return this.doPut((double)key, (char)value, (int)index);
    }

    @Override
    public char putIfAbsent(double key, char value) {
        int index = this.insertKey((double)key);
        if (index >= 0) return this.doPut((double)key, (char)value, (int)index);
    ...
    public void putAll(Map<? extends Double, ? extends Character> map) {
        ...
        Iterator<Map.Entry<? extends Double, ? extends Character>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Double, ? extends Character> entry = iterator.next();
            this.put((double)entry.getKey().doubleValue(), (char)entry.getValue().charValue());
        }
    }
    ...
    public void putAll(TDoubleCharMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((double)iter.key(), (char)iter.value());
        }
    }
    ...
    public TDoubleSet keySet() {
        return new TKeyView((TDoubleCharHashMap)this);
    }
    ...
    public TCharCollection valueCollection() {
        return new TValueView((TDoubleCharHashMap)this);
    }
    ...
    public TDoubleCharIterator iterator() {
        return new TDoubleCharHashIterator((TDoubleCharHashMap)this, (TDoubleCharHashMap)this);
    }
    ...
    public boolean forEachEntry(TDoubleCharProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((double)keys[i], (char)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TDoubleCharProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((double)keys[i], (char)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(double key) {
        return this.adjustValue((double)key, (char)'\u0001');
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TDoubleCharProcedure)new TDoubleCharProcedure((TDoubleCharHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TDoubleCharHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((double)key, (char)val);
        }
    }

    static /* synthetic */ double access$000(TDoubleCharHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TDoubleCharHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TDoubleCharHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ char access$300(TDoubleCharHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ char access$400(TDoubleCharHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TDoubleCharHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TDoubleCharHashMap x0) {
        return x0._size;
    }
}
