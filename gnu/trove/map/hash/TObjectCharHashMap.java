...
Externalizable {
    ...
    private final TObjectCharProcedure<K> PUT_ALL_PROC = new TObjectCharProcedure<K>((TObjectCharHashMap)this){
        final /* synthetic */ TObjectCharHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectCharHashMap(TObjectCharMap<? extends K> map) {
        this((int)map.size(), (float)0.5f, (char)map.getNoEntryValue());
        if (map instanceof TObjectCharHashMap) {
            ...
            this.setUp((int)TObjectCharHashMap.saturatedCast((long)TObjectCharHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectCharHashMap)this);
    }
    ...
    public TCharCollection valueCollection() {
        return new TCharValueCollection((TObjectCharHashMap)this);
    }
    ...
    public TObjectCharIterator<K> iterator() {
        return new TObjectCharHashIterator<K>((TObjectCharHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectCharProcedure<K>((TObjectCharHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectCharHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectCharHashMap x0) {
        return x0._size;
    }
}
