...
Externalizable {
    ...
    public TLongDoubleHashMap(int initialCapacity, float loadFactor, long noEntryKey, double noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (long)noEntryKey, (double)noEntryValue);
    }
    ...
    public TLongDoubleHashMap(long[] keys, double[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((long)keys[i], (double)values[i]);
            ++i;
        }
    }
    ...
    public TLongDoubleHashMap(TLongDoubleMap map) {
        ...
        if (map instanceof TLongDoubleHashMap) {
            ...
            this.setUp((int)TLongDoubleHashMap.saturatedCast((long)TLongDoubleHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TLongDoubleMap)map);
    }
    ...
    public double put(long key, double value) {
        ...
        return this.doPut((long)key, (double)value, (int)index);
    }

    @Override
    public double putIfAbsent(long key, double value) {
        int index = this.insertKey((long)key);
        if (index >= 0) return this.doPut((long)key, (double)value, (int)index);
    ...
    public void putAll(Map<? extends Long, ? extends Double> map) {
        ...
        Iterator<Map.Entry<? extends Long, ? extends Double>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Long, ? extends Double> entry = iterator.next();
            this.put((long)entry.getKey().longValue(), (double)entry.getValue().doubleValue());
        }
    }
    ...
    public void putAll(TLongDoubleMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((long)iter.key(), (double)iter.value());
        }
    }
    ...
    public TLongSet keySet() {
        return new TKeyView((TLongDoubleHashMap)this);
    }
    ...
    public TDoubleCollection valueCollection() {
        return new TValueView((TLongDoubleHashMap)this);
    }
    ...
    public TLongDoubleIterator iterator() {
        return new TLongDoubleHashIterator((TLongDoubleHashMap)this, (TLongDoubleHashMap)this);
    }
    ...
    public boolean forEachEntry(TLongDoubleProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((long)keys[i], (double)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TLongDoubleProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((long)keys[i], (double)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(long key) {
        return this.adjustValue((long)key, (double)1.0);
    }
    ...
    public int hashCode() {
        ...
        while (i-- > 0) {
            if (states[i] != 1) continue;
            hashcode += HashFunctions.hash((long)this._set[i]) ^ HashFunctions.hash((double)this._values[i]);
        }
        return hashcode;
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TLongDoubleProcedure)new TLongDoubleProcedure((TLongDoubleHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TLongDoubleHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((long)key, (double)val);
        }
    }

    static /* synthetic */ long access$000(TLongDoubleHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TLongDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TLongDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ double access$300(TLongDoubleHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ double access$400(TLongDoubleHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TLongDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TLongDoubleHashMap x0) {
        return x0._size;
    }
}
