...
Externalizable {
    ...
    public TFloatShortHashMap(int initialCapacity, float loadFactor, float noEntryKey, short noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (float)noEntryKey, (short)noEntryValue);
    }
    ...
    public TFloatShortHashMap(float[] keys, short[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((float)keys[i], (short)values[i]);
            ++i;
        }
    }
    ...
    public TFloatShortHashMap(TFloatShortMap map) {
        ...
        if (map instanceof TFloatShortHashMap) {
            ...
            this.setUp((int)TFloatShortHashMap.saturatedCast((long)TFloatShortHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TFloatShortMap)map);
    }
    ...
    public short put(float key, short value) {
        ...
        return this.doPut((float)key, (short)value, (int)index);
    }

    @Override
    public short putIfAbsent(float key, short value) {
        int index = this.insertKey((float)key);
        if (index >= 0) return this.doPut((float)key, (short)value, (int)index);
    ...
    public void putAll(Map<? extends Float, ? extends Short> map) {
        ...
        Iterator<Map.Entry<? extends Float, ? extends Short>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Float, ? extends Short> entry = iterator.next();
            this.put((float)entry.getKey().floatValue(), (short)entry.getValue().shortValue());
        }
    }
    ...
    public void putAll(TFloatShortMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((float)iter.key(), (short)iter.value());
        }
    }
    ...
    public TFloatSet keySet() {
        return new TKeyView((TFloatShortHashMap)this);
    }
    ...
    public TShortCollection valueCollection() {
        return new TValueView((TFloatShortHashMap)this);
    }
    ...
    public TFloatShortIterator iterator() {
        return new TFloatShortHashIterator((TFloatShortHashMap)this, (TFloatShortHashMap)this);
    }
    ...
    public boolean forEachEntry(TFloatShortProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((float)keys[i], (short)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TFloatShortProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((float)keys[i], (short)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(float key) {
        return this.adjustValue((float)key, (short)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TFloatShortProcedure)new TFloatShortProcedure((TFloatShortHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TFloatShortHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((float)key, (short)val);
        }
    }

    static /* synthetic */ float access$000(TFloatShortHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TFloatShortHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TFloatShortHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ short access$300(TFloatShortHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ short access$400(TFloatShortHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TFloatShortHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TFloatShortHashMap x0) {
        return x0._size;
    }
}
