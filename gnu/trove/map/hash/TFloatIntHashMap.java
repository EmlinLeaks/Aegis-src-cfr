...
Externalizable {
    ...
    public TFloatIntHashMap(int initialCapacity, float loadFactor, float noEntryKey, int noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (float)noEntryKey, (int)noEntryValue);
    }
    ...
    public TFloatIntHashMap(float[] keys, int[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((float)keys[i], (int)values[i]);
            ++i;
        }
    }
    ...
    public TFloatIntHashMap(TFloatIntMap map) {
        ...
        if (map instanceof TFloatIntHashMap) {
            ...
            this.setUp((int)TFloatIntHashMap.saturatedCast((long)TFloatIntHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TFloatIntMap)map);
    }
    ...
    public int put(float key, int value) {
        ...
        return this.doPut((float)key, (int)value, (int)index);
    }

    @Override
    public int putIfAbsent(float key, int value) {
        int index = this.insertKey((float)key);
        if (index >= 0) return this.doPut((float)key, (int)value, (int)index);
    ...
    public void putAll(Map<? extends Float, ? extends Integer> map) {
        ...
        Iterator<Map.Entry<? extends Float, ? extends Integer>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Float, ? extends Integer> entry = iterator.next();
            this.put((float)entry.getKey().floatValue(), (int)entry.getValue().intValue());
        }
    }
    ...
    public void putAll(TFloatIntMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((float)iter.key(), (int)iter.value());
        }
    }
    ...
    public TFloatSet keySet() {
        return new TKeyView((TFloatIntHashMap)this);
    }
    ...
    public TIntCollection valueCollection() {
        return new TValueView((TFloatIntHashMap)this);
    }
    ...
    public TFloatIntIterator iterator() {
        return new TFloatIntHashIterator((TFloatIntHashMap)this, (TFloatIntHashMap)this);
    }
    ...
    public boolean forEachEntry(TFloatIntProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((float)keys[i], (int)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TFloatIntProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((float)keys[i], (int)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(float key) {
        return this.adjustValue((float)key, (int)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TFloatIntProcedure)new TFloatIntProcedure((TFloatIntHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TFloatIntHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            int val = in.readInt();
            this.put((float)key, (int)val);
        }
    }

    static /* synthetic */ float access$000(TFloatIntHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TFloatIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TFloatIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$300(TFloatIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$400(TFloatIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TFloatIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TFloatIntHashMap x0) {
        return x0._size;
    }
}
