...
Externalizable {
    ...
    public TFloatLongHashMap(int initialCapacity, float loadFactor, float noEntryKey, long noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (float)noEntryKey, (long)noEntryValue);
    }
    ...
    public TFloatLongHashMap(float[] keys, long[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((float)keys[i], (long)values[i]);
            ++i;
        }
    }
    ...
    public TFloatLongHashMap(TFloatLongMap map) {
        ...
        if (map instanceof TFloatLongHashMap) {
            ...
            this.setUp((int)TFloatLongHashMap.saturatedCast((long)TFloatLongHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TFloatLongMap)map);
    }
    ...
    public long put(float key, long value) {
        ...
        return this.doPut((float)key, (long)value, (int)index);
    }

    @Override
    public long putIfAbsent(float key, long value) {
        int index = this.insertKey((float)key);
        if (index >= 0) return this.doPut((float)key, (long)value, (int)index);
    ...
    public void putAll(Map<? extends Float, ? extends Long> map) {
        ...
        Iterator<Map.Entry<? extends Float, ? extends Long>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Float, ? extends Long> entry = iterator.next();
            this.put((float)entry.getKey().floatValue(), (long)entry.getValue().longValue());
        }
    }
    ...
    public void putAll(TFloatLongMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((float)iter.key(), (long)iter.value());
        }
    }
    ...
    public TFloatSet keySet() {
        return new TKeyView((TFloatLongHashMap)this);
    }
    ...
    public TLongCollection valueCollection() {
        return new TValueView((TFloatLongHashMap)this);
    }
    ...
    public TFloatLongIterator iterator() {
        return new TFloatLongHashIterator((TFloatLongHashMap)this, (TFloatLongHashMap)this);
    }
    ...
    public boolean forEachEntry(TFloatLongProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((float)keys[i], (long)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TFloatLongProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((float)keys[i], (long)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(float key) {
        return this.adjustValue((float)key, (long)1L);
    }
    ...
    public int hashCode() {
        ...
        while (i-- > 0) {
            if (states[i] != 1) continue;
            hashcode += HashFunctions.hash((float)this._set[i]) ^ HashFunctions.hash((long)this._values[i]);
        }
        return hashcode;
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TFloatLongProcedure)new TFloatLongProcedure((TFloatLongHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TFloatLongHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((float)key, (long)val);
        }
    }

    static /* synthetic */ float access$000(TFloatLongHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TFloatLongHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TFloatLongHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ long access$300(TFloatLongHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ long access$400(TFloatLongHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TFloatLongHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TFloatLongHashMap x0) {
        return x0._size;
    }
}
