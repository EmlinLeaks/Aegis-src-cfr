...
Externalizable {
    ...
    public TDoubleIntHashMap(int initialCapacity, float loadFactor, double noEntryKey, int noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (double)noEntryKey, (int)noEntryValue);
    }
    ...
    public TDoubleIntHashMap(double[] keys, int[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((double)keys[i], (int)values[i]);
            ++i;
        }
    }
    ...
    public TDoubleIntHashMap(TDoubleIntMap map) {
        ...
        if (map instanceof TDoubleIntHashMap) {
            ...
            this.setUp((int)TDoubleIntHashMap.saturatedCast((long)TDoubleIntHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TDoubleIntMap)map);
    }
    ...
    public int put(double key, int value) {
        ...
        return this.doPut((double)key, (int)value, (int)index);
    }

    @Override
    public int putIfAbsent(double key, int value) {
        int index = this.insertKey((double)key);
        if (index >= 0) return this.doPut((double)key, (int)value, (int)index);
    ...
    public void putAll(Map<? extends Double, ? extends Integer> map) {
        ...
        Iterator<Map.Entry<? extends Double, ? extends Integer>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Double, ? extends Integer> entry = iterator.next();
            this.put((double)entry.getKey().doubleValue(), (int)entry.getValue().intValue());
        }
    }
    ...
    public void putAll(TDoubleIntMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((double)iter.key(), (int)iter.value());
        }
    }
    ...
    public TDoubleSet keySet() {
        return new TKeyView((TDoubleIntHashMap)this);
    }
    ...
    public TIntCollection valueCollection() {
        return new TValueView((TDoubleIntHashMap)this);
    }
    ...
    public TDoubleIntIterator iterator() {
        return new TDoubleIntHashIterator((TDoubleIntHashMap)this, (TDoubleIntHashMap)this);
    }
    ...
    public boolean forEachEntry(TDoubleIntProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((double)keys[i], (int)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TDoubleIntProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((double)keys[i], (int)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(double key) {
        return this.adjustValue((double)key, (int)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TDoubleIntProcedure)new TDoubleIntProcedure((TDoubleIntHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TDoubleIntHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            int val = in.readInt();
            this.put((double)key, (int)val);
        }
    }

    static /* synthetic */ double access$000(TDoubleIntHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TDoubleIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TDoubleIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$300(TDoubleIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$400(TDoubleIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TDoubleIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TDoubleIntHashMap x0) {
        return x0._size;
    }
}
