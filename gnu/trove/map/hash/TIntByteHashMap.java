...
Externalizable {
    ...
    public TIntByteHashMap(int initialCapacity, float loadFactor, int noEntryKey, byte noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (int)noEntryKey, (byte)noEntryValue);
    }
    ...
    public TIntByteHashMap(int[] keys, byte[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((int)keys[i], (byte)values[i]);
            ++i;
        }
    }
    ...
    public TIntByteHashMap(TIntByteMap map) {
        ...
        if (map instanceof TIntByteHashMap) {
            ...
            this.setUp((int)TIntByteHashMap.saturatedCast((long)TIntByteHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TIntByteMap)map);
    }
    ...
    public byte put(int key, byte value) {
        ...
        return this.doPut((int)key, (byte)value, (int)index);
    }

    @Override
    public byte putIfAbsent(int key, byte value) {
        int index = this.insertKey((int)key);
        if (index >= 0) return this.doPut((int)key, (byte)value, (int)index);
    ...
    public void putAll(Map<? extends Integer, ? extends Byte> map) {
        ...
        Iterator<Map.Entry<? extends Integer, ? extends Byte>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Integer, ? extends Byte> entry = iterator.next();
            this.put((int)entry.getKey().intValue(), (byte)entry.getValue().byteValue());
        }
    }
    ...
    public void putAll(TIntByteMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((int)iter.key(), (byte)iter.value());
        }
    }
    ...
    public TIntSet keySet() {
        return new TKeyView((TIntByteHashMap)this);
    }
    ...
    public TByteCollection valueCollection() {
        return new TValueView((TIntByteHashMap)this);
    }
    ...
    public TIntByteIterator iterator() {
        return new TIntByteHashIterator((TIntByteHashMap)this, (TIntByteHashMap)this);
    }
    ...
    public boolean forEachEntry(TIntByteProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((int)keys[i], (byte)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TIntByteProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((int)keys[i], (byte)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(int key) {
        return this.adjustValue((int)key, (byte)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TIntByteProcedure)new TIntByteProcedure((TIntByteHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TIntByteHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((int)key, (byte)val);
        }
    }

    static /* synthetic */ int access$000(TIntByteHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TIntByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TIntByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ byte access$300(TIntByteHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ byte access$400(TIntByteHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TIntByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TIntByteHashMap x0) {
        return x0._size;
    }
}
