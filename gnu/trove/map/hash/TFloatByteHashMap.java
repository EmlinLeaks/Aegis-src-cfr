...
Externalizable {
    ...
    public TFloatByteHashMap(int initialCapacity, float loadFactor, float noEntryKey, byte noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (float)noEntryKey, (byte)noEntryValue);
    }
    ...
    public TFloatByteHashMap(float[] keys, byte[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((float)keys[i], (byte)values[i]);
            ++i;
        }
    }
    ...
    public TFloatByteHashMap(TFloatByteMap map) {
        ...
        if (map instanceof TFloatByteHashMap) {
            ...
            this.setUp((int)TFloatByteHashMap.saturatedCast((long)TFloatByteHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TFloatByteMap)map);
    }
    ...
    public byte put(float key, byte value) {
        ...
        return this.doPut((float)key, (byte)value, (int)index);
    }

    @Override
    public byte putIfAbsent(float key, byte value) {
        int index = this.insertKey((float)key);
        if (index >= 0) return this.doPut((float)key, (byte)value, (int)index);
    ...
    public void putAll(Map<? extends Float, ? extends Byte> map) {
        ...
        Iterator<Map.Entry<? extends Float, ? extends Byte>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Float, ? extends Byte> entry = iterator.next();
            this.put((float)entry.getKey().floatValue(), (byte)entry.getValue().byteValue());
        }
    }
    ...
    public void putAll(TFloatByteMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((float)iter.key(), (byte)iter.value());
        }
    }
    ...
    public TFloatSet keySet() {
        return new TKeyView((TFloatByteHashMap)this);
    }
    ...
    public TByteCollection valueCollection() {
        return new TValueView((TFloatByteHashMap)this);
    }
    ...
    public TFloatByteIterator iterator() {
        return new TFloatByteHashIterator((TFloatByteHashMap)this, (TFloatByteHashMap)this);
    }
    ...
    public boolean forEachEntry(TFloatByteProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((float)keys[i], (byte)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TFloatByteProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((float)keys[i], (byte)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(float key) {
        return this.adjustValue((float)key, (byte)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TFloatByteProcedure)new TFloatByteProcedure((TFloatByteHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TFloatByteHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((float)key, (byte)val);
        }
    }

    static /* synthetic */ float access$000(TFloatByteHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TFloatByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TFloatByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ byte access$300(TFloatByteHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ byte access$400(TFloatByteHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TFloatByteHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TFloatByteHashMap x0) {
        return x0._size;
    }
}
