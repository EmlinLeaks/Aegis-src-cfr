...
Externalizable {
    ...
    public TDoubleDoubleHashMap(int initialCapacity, float loadFactor, double noEntryKey, double noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (double)noEntryKey, (double)noEntryValue);
    }
    ...
    public TDoubleDoubleHashMap(double[] keys, double[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((double)keys[i], (double)values[i]);
            ++i;
        }
    }
    ...
    public TDoubleDoubleHashMap(TDoubleDoubleMap map) {
        ...
        if (map instanceof TDoubleDoubleHashMap) {
            ...
            this.setUp((int)TDoubleDoubleHashMap.saturatedCast((long)TDoubleDoubleHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TDoubleDoubleMap)map);
    }
    ...
    public double put(double key, double value) {
        ...
        return this.doPut((double)key, (double)value, (int)index);
    }

    @Override
    public double putIfAbsent(double key, double value) {
        int index = this.insertKey((double)key);
        if (index >= 0) return this.doPut((double)key, (double)value, (int)index);
    ...
    public void putAll(Map<? extends Double, ? extends Double> map) {
        ...
        Iterator<Map.Entry<? extends Double, ? extends Double>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Double, ? extends Double> entry = iterator.next();
            this.put((double)entry.getKey().doubleValue(), (double)entry.getValue().doubleValue());
        }
    }
    ...
    public void putAll(TDoubleDoubleMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((double)iter.key(), (double)iter.value());
        }
    }
    ...
    public TDoubleSet keySet() {
        return new TKeyView((TDoubleDoubleHashMap)this);
    }
    ...
    public TDoubleCollection valueCollection() {
        return new TValueView((TDoubleDoubleHashMap)this);
    }
    ...
    public TDoubleDoubleIterator iterator() {
        return new TDoubleDoubleHashIterator((TDoubleDoubleHashMap)this, (TDoubleDoubleHashMap)this);
    }
    ...
    public boolean forEachEntry(TDoubleDoubleProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((double)keys[i], (double)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TDoubleDoubleProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((double)keys[i], (double)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(double key) {
        return this.adjustValue((double)key, (double)1.0);
    }
    ...
    public int hashCode() {
        ...
        while (i-- > 0) {
            if (states[i] != 1) continue;
            hashcode += HashFunctions.hash((double)this._set[i]) ^ HashFunctions.hash((double)this._values[i]);
        }
        return hashcode;
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TDoubleDoubleProcedure)new TDoubleDoubleProcedure((TDoubleDoubleHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TDoubleDoubleHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            ...
            this.put((double)key, (double)val);
        }
    }

    static /* synthetic */ double access$000(TDoubleDoubleHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TDoubleDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TDoubleDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ double access$300(TDoubleDoubleHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ double access$400(TDoubleDoubleHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TDoubleDoubleHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TDoubleDoubleHashMap x0) {
        return x0._size;
    }
}
