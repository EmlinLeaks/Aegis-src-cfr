...
Externalizable {
    ...
    public TIntIntHashMap(int initialCapacity, float loadFactor, int noEntryKey, int noEntryValue) {
        super((int)initialCapacity, (float)loadFactor, (int)noEntryKey, (int)noEntryValue);
    }
    ...
    public TIntIntHashMap(int[] keys, int[] values) {
        ...
        int i = 0;
        while (i < size) {
            this.put((int)keys[i], (int)values[i]);
            ++i;
        }
    }
    ...
    public TIntIntHashMap(TIntIntMap map) {
        ...
        if (map instanceof TIntIntHashMap) {
            ...
            this.setUp((int)TIntIntHashMap.saturatedCast((long)TIntIntHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll((TIntIntMap)map);
    }
    ...
    public int put(int key, int value) {
        ...
        return this.doPut((int)key, (int)value, (int)index);
    }

    @Override
    public int putIfAbsent(int key, int value) {
        int index = this.insertKey((int)key);
        if (index >= 0) return this.doPut((int)key, (int)value, (int)index);
    ...
    public void putAll(Map<? extends Integer, ? extends Integer> map) {
        ...
        Iterator<Map.Entry<? extends Integer, ? extends Integer>> iterator = map.entrySet().iterator();
        while (iterator.hasNext()) {
            Map.Entry<? extends Integer, ? extends Integer> entry = iterator.next();
            this.put((int)entry.getKey().intValue(), (int)entry.getValue().intValue());
        }
    }
    ...
    public void putAll(TIntIntMap map) {
        ...
        while (iter.hasNext()) {
            iter.advance();
            this.put((int)iter.key(), (int)iter.value());
        }
    }
    ...
    public TIntSet keySet() {
        return new TKeyView((TIntIntHashMap)this);
    }
    ...
    public TIntCollection valueCollection() {
        return new TValueView((TIntIntHashMap)this);
    }
    ...
    public TIntIntIterator iterator() {
        return new TIntIntHashIterator((TIntIntHashMap)this, (TIntIntHashMap)this);
    }
    ...
    public boolean forEachEntry(TIntIntProcedure procedure) {
        ...
        do {
            if (i-- <= 0) return true;
        } while (states[i] != 1 || procedure.execute((int)keys[i], (int)values[i]));
        return false;
    }
    ...
    public boolean retainEntries(TIntIntProcedure procedure) {
        ...
        try {
            int i = keys.length;
            while (i-- > 0) {
                if (states[i] != 1 || procedure.execute((int)keys[i], (int)values[i])) continue;
                this.removeAt((int)i);
                modified = true;
            }
            return modified;
    ...
    public boolean increment(int key) {
        return this.adjustValue((int)key, (int)1);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry((TIntIntProcedure)new TIntIntProcedure((TIntIntHashMap)this, (StringBuilder)buf){
            private boolean first;
            final /* synthetic */ StringBuilder val$buf;
            final /* synthetic */ TIntIntHashMap this$0;
            {
                this.this$0 = this$0;
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        while (size-- > 0) {
            int key = in.readInt();
            int val = in.readInt();
            this.put((int)key, (int)val);
        }
    }

    static /* synthetic */ int access$000(TIntIntHashMap x0) {
        return x0.no_entry_key;
    }

    static /* synthetic */ int access$100(TIntIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TIntIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$300(TIntIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$400(TIntIntHashMap x0) {
        return x0.no_entry_value;
    }

    static /* synthetic */ int access$500(TIntIntHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$600(TIntIntHashMap x0) {
        return x0._size;
    }
}
