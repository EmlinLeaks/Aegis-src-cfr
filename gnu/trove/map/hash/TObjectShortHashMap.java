...
Externalizable {
    ...
    private final TObjectShortProcedure<K> PUT_ALL_PROC = new TObjectShortProcedure<K>((TObjectShortHashMap)this){
        final /* synthetic */ TObjectShortHashMap this$0;
        {
            this.this$0 = this$0;
        }
    ...
    public TObjectShortHashMap(TObjectShortMap<? extends K> map) {
        this((int)map.size(), (float)0.5f, (short)map.getNoEntryValue());
        if (map instanceof TObjectShortHashMap) {
            ...
            this.setUp((int)TObjectShortHashMap.saturatedCast((long)TObjectShortHashMap.fastCeil((double)(10.0 / (double)this._loadFactor))));
        }
        this.putAll(map);
    }
    ...
    @Override
    public Set<K> keySet() {
        return new KeyView((TObjectShortHashMap)this);
    }
    ...
    public TShortCollection valueCollection() {
        return new TShortValueCollection((TObjectShortHashMap)this);
    }
    ...
    public TObjectShortIterator<K> iterator() {
        return new TObjectShortHashIterator<K>((TObjectShortHashMap)this, this);
    }
    ...
    public String toString() {
        ...
        this.forEachEntry(new TObjectShortProcedure<K>((TObjectShortHashMap)this, (StringBuilder)buf){
    ...
    static /* synthetic */ int access$100(TObjectShortHashMap x0) {
        return x0._size;
    }

    static /* synthetic */ int access$200(TObjectShortHashMap x0) {
        return x0._size;
    }
}
