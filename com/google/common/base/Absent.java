...
extends Optional<T> {
    ...
    @Override
    public T get() {
        throw new IllegalStateException((String)"Optional.get() cannot be called on an absent value");
    }
    ...
    public T or(Supplier<? extends T> supplier) {
        return (T)Preconditions.checkNotNull(supplier.get(), (Object)"use Optional.orNull() instead of a Supplier that returns null");
    }
