...
extends AbstractGraphBuilder<N> {
    ...
    public static NetworkBuilder<Object, Object> directed() {
        return new NetworkBuilder<Object, Object>((boolean)true);
    }

    public static NetworkBuilder<Object, Object> undirected() {
        return new NetworkBuilder<Object, Object>((boolean)false);
    }

    public static <N, E> NetworkBuilder<N, E> from(Network<N, E> network) {
        return new NetworkBuilder<N, E>((boolean)network.isDirected()).allowsParallelEdges((boolean)network.allowsParallelEdges()).allowsSelfLoops((boolean)network.allowsSelfLoops()).nodeOrder(network.nodeOrder()).edgeOrder(network.edgeOrder());
    }
    ...
    public NetworkBuilder<N, E> expectedEdgeCount(int expectedEdgeCount) {
        this.expectedEdgeCount = Optional.of(Integer.valueOf((int)Graphs.checkNonNegative((int)expectedEdgeCount)));
        return this;
    }
    ...
    public <N1 extends N, E1 extends E> MutableNetwork<N1, E1> build() {
        return new ConfigurableMutableNetwork<N, E>(this);
    }
