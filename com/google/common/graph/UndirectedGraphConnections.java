...
implements GraphConnections<N, V> {
    ...
    static <N, V> UndirectedGraphConnections<N, V> of() {
        return new UndirectedGraphConnections<K, V>(new HashMap<K, V>((int)2, (float)1.0f));
    }
    ...
    public V value(Object node) {
        return (V)this.adjacentNodeValues.get((Object)node);
    }

    @Override
    public void removePredecessor(Object node) {
        V unused = this.removeSuccessor((Object)node);
    }

    @Override
    public V removeSuccessor(Object node) {
        return (V)this.adjacentNodeValues.remove((Object)node);
    }
