...
extends AbstractCollection<V> {
    ...
    public boolean contains(@Nullable Object o) {
        return this.multimap.containsValue((Object)o);
    }
    ...
    public boolean remove(@Nullable Object o) {
        ...
        do {
            if (!unfilteredItr.hasNext()) return false;
        } while (!entryPredicate.apply(entry = unfilteredItr.next()) || !Objects.equal(entry.getValue(), (Object)o));
