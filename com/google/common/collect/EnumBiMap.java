...
extends AbstractBiMap<K, V> {
    ...
    private EnumBiMap(Class<K> keyType, Class<V> valueType) {
        super(WellBehavedMap.wrap(new EnumMap<K, V>(keyType)), WellBehavedMap.wrap(new EnumMap<V, V>(valueType)));
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        this.setDelegates(WellBehavedMap.wrap(new EnumMap<K, V>(this.keyType)), WellBehavedMap.wrap(new EnumMap<V, V>(this.valueType)));
