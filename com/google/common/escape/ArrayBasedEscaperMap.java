...
public final class ArrayBasedEscaperMap {
    ...
    public static ArrayBasedEscaperMap create(Map<Character, String> replacements) {
        return new ArrayBasedEscaperMap((char[][])ArrayBasedEscaperMap.createReplacementArray(replacements));
    }
    ...
    static char[][] createReplacementArray(Map<Character, String> map) {
        ...
        while (i$.hasNext()) {
            ...
            replacements[c] = map.get((Object)Character.valueOf((char)c)).toCharArray();
        }
        return replacements;
    }
}
