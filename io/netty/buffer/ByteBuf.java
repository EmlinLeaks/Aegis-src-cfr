...
Comparable<ByteBuf> {
    ...
    public float getFloatLE(int index) {
        return Float.intBitsToFloat((int)this.getIntLE((int)index));
    }

    public abstract double getDouble(int var1);

    public double getDoubleLE(int index) {
        return Double.longBitsToDouble((long)this.getLongLE((int)index));
    }
    ...
    public ByteBuf setFloatLE(int index, float value) {
        return this.setIntLE((int)index, (int)Float.floatToRawIntBits((float)value));
    }

    public abstract ByteBuf setDouble(int var1, double var2);

    public ByteBuf setDoubleLE(int index, double value) {
        return this.setLongLE((int)index, (long)Double.doubleToRawLongBits((double)value));
    }
    ...
    public float readFloatLE() {
        return Float.intBitsToFloat((int)this.readIntLE());
    }

    public abstract double readDouble();

    public double readDoubleLE() {
        return Double.longBitsToDouble((long)this.readLongLE());
    }
    ...
    public ByteBuf writeFloatLE(float value) {
        return this.writeIntLE((int)Float.floatToRawIntBits((float)value));
    }

    public abstract ByteBuf writeDouble(double var1);

    public ByteBuf writeDoubleLE(double value) {
        return this.writeLongLE((long)Double.doubleToRawLongBits((double)value));
    }
