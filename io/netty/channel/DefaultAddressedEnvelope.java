...
implements AddressedEnvelope<M, A> {
    ...
    public DefaultAddressedEnvelope(M message, A recipient, A sender) {
        ...
        if (recipient == null && sender == null) {
            throw new NullPointerException((String)"recipient and sender");
        }
    ...
    @Override
    public int refCnt() {
        if (!(this.message instanceof ReferenceCounted)) return 1;
    ...
    public String toString() {
        if (this.sender == null) return StringUtil.simpleClassName((Object)this) + "(=> " + this.recipient + ", " + this.message + ')';
