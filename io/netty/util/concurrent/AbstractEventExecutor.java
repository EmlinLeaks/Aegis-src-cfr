...
implements EventExecutor {
    ...
    public boolean inEventLoop() {
        return this.inEventLoop((Thread)Thread.currentThread());
    }
    ...
    protected final <T> RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
        return new PromiseTask<T>((EventExecutor)this, (Runnable)runnable, value);
    }
    ...
    protected static void safeExecute(Runnable task) {
        try {
            ...
            logger.warn((String)"A task raised an exception. Task: {}", (Object)task, (Object)t);
        }
    }
}
