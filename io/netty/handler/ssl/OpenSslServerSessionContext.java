...
extends OpenSslSessionContext {
    OpenSslServerSessionContext(ReferenceCountedOpenSslContext context, OpenSslKeyMaterialProvider provider) {
        super((ReferenceCountedOpenSslContext)context, (OpenSslKeyMaterialProvider)provider);
    }
    ...
    public void setSessionTimeout(int seconds) {
        ...
        writerLock.lock();
        try {
            SSLContext.setSessionCacheTimeout((long)this.context.ctx, (long)((long)seconds));
            return;
        }
        finally {
            writerLock.unlock();
    ...
    public void setSessionCacheSize(int size) {
        ...
        writerLock.lock();
        try {
            SSLContext.setSessionCacheSize((long)this.context.ctx, (long)((long)size));
            return;
        }
        finally {
            writerLock.unlock();
