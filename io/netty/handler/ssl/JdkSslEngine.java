...
implements ApplicationProtocolAccessor {
    ...
    public SSLEngineResult wrap(ByteBuffer byteBuffer, ByteBuffer byteBuffer2) throws SSLException {
        return this.engine.wrap((ByteBuffer)byteBuffer, (ByteBuffer)byteBuffer2);
    }

    @Override
    public SSLEngineResult wrap(ByteBuffer[] byteBuffers, ByteBuffer byteBuffer) throws SSLException {
        return this.engine.wrap((ByteBuffer[])byteBuffers, (ByteBuffer)byteBuffer);
    }

    @Override
    public SSLEngineResult wrap(ByteBuffer[] byteBuffers, int i, int i2, ByteBuffer byteBuffer) throws SSLException {
        return this.engine.wrap((ByteBuffer[])byteBuffers, (int)i, (int)i2, (ByteBuffer)byteBuffer);
    }

    @Override
    public SSLEngineResult unwrap(ByteBuffer byteBuffer, ByteBuffer byteBuffer2) throws SSLException {
        return this.engine.unwrap((ByteBuffer)byteBuffer, (ByteBuffer)byteBuffer2);
    }

    @Override
    public SSLEngineResult unwrap(ByteBuffer byteBuffer, ByteBuffer[] byteBuffers) throws SSLException {
        return this.engine.unwrap((ByteBuffer)byteBuffer, (ByteBuffer[])byteBuffers);
    }

    @Override
    public SSLEngineResult unwrap(ByteBuffer byteBuffer, ByteBuffer[] byteBuffers, int i, int i2) throws SSLException {
        return this.engine.unwrap((ByteBuffer)byteBuffer, (ByteBuffer[])byteBuffers, (int)i, (int)i2);
    }
    ...
    public void setEnabledCipherSuites(String[] strings) {
        this.engine.setEnabledCipherSuites((String[])strings);
    }
    ...
    public void setEnabledProtocols(String[] strings) {
        this.engine.setEnabledProtocols((String[])strings);
    }
    ...
    public void setUseClientMode(boolean b) {
        this.engine.setUseClientMode((boolean)b);
    }
    ...
    public void setNeedClientAuth(boolean b) {
        this.engine.setNeedClientAuth((boolean)b);
    }
    ...
    public void setWantClientAuth(boolean b) {
        this.engine.setWantClientAuth((boolean)b);
    }
    ...
    public void setEnableSessionCreation(boolean b) {
        this.engine.setEnableSessionCreation((boolean)b);
    }
    ...
    public void setSSLParameters(SSLParameters sslParameters) {
        this.engine.setSSLParameters((SSLParameters)sslParameters);
    }
}
