...
implements OpenSslApplicationProtocolNegotiator {
    ...
    public OpenSslNpnApplicationProtocolNegotiator(Iterable<String> protocols) {
        this.protocols = ObjectUtil.checkNotNull(ApplicationProtocolUtil.toList(protocols), (String)"protocols");
    }

    public OpenSslNpnApplicationProtocolNegotiator(String ... protocols) {
        this.protocols = ObjectUtil.checkNotNull(ApplicationProtocolUtil.toList((String[])protocols), (String)"protocols");
    }
