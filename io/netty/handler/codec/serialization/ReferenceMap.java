...
implements Map<K, V> {
    ...
    public V get(Object key) {
        return (V)this.unfold(this.delegate.get((Object)key));
    }

    @Override
    public V put(K key, V value) {
        return (V)this.unfold(this.delegate.put(key, this.fold(value)));
    }

    @Override
    public V remove(Object key) {
        return (V)this.unfold(this.delegate.remove((Object)key));
    }
