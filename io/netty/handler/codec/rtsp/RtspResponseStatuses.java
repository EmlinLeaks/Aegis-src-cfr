...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus LOW_STORAGE_SPACE = new HttpResponseStatus((int)250, (String)"Low on Storage Space");
    ...
    public static final HttpResponseStatus MOVED_TEMPORARILY = new HttpResponseStatus((int)302, (String)"Moved Temporarily");
    ...
    public static final HttpResponseStatus PARAMETER_NOT_UNDERSTOOD = new HttpResponseStatus((int)451, (String)"Parameter Not Understood");
    public static final HttpResponseStatus CONFERENCE_NOT_FOUND = new HttpResponseStatus((int)452, (String)"Conference Not Found");
    public static final HttpResponseStatus NOT_ENOUGH_BANDWIDTH = new HttpResponseStatus((int)453, (String)"Not Enough Bandwidth");
    public static final HttpResponseStatus SESSION_NOT_FOUND = new HttpResponseStatus((int)454, (String)"Session Not Found");
    public static final HttpResponseStatus METHOD_NOT_VALID = new HttpResponseStatus((int)455, (String)"Method Not Valid in This State");
    public static final HttpResponseStatus HEADER_FIELD_NOT_VALID = new HttpResponseStatus((int)456, (String)"Header Field Not Valid for Resource");
    public static final HttpResponseStatus INVALID_RANGE = new HttpResponseStatus((int)457, (String)"Invalid Range");
    public static final HttpResponseStatus PARAMETER_IS_READONLY = new HttpResponseStatus((int)458, (String)"Parameter Is Read-Only");
    public static final HttpResponseStatus AGGREGATE_OPERATION_NOT_ALLOWED = new HttpResponseStatus((int)459, (String)"Aggregate operation not allowed");
    public static final HttpResponseStatus ONLY_AGGREGATE_OPERATION_ALLOWED = new HttpResponseStatus((int)460, (String)"Only Aggregate operation allowed");
    public static final HttpResponseStatus UNSUPPORTED_TRANSPORT = new HttpResponseStatus((int)461, (String)"Unsupported transport");
    public static final HttpResponseStatus DESTINATION_UNREACHABLE = new HttpResponseStatus((int)462, (String)"Destination unreachable");
    public static final HttpResponseStatus KEY_MANAGEMENT_FAILURE = new HttpResponseStatus((int)463, (String)"Key management failure");
    ...
    public static final HttpResponseStatus RTSP_VERSION_NOT_SUPPORTED = new HttpResponseStatus((int)505, (String)"RTSP Version not supported");
    public static final HttpResponseStatus OPTION_NOT_SUPPORTED = new HttpResponseStatus((int)551, (String)"Option not supported");
