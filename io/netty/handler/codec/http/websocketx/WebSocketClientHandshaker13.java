...
extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug((String)"WebSocket version 13 client handshake key: {}, expected response: {}", (Object)key, (Object)this.expectedChallengeResponseString);
        }
        ...
        headers.set((CharSequence)HttpHeaderNames.UPGRADE, (Object)HttpHeaderValues.WEBSOCKET).set((CharSequence)HttpHeaderNames.CONNECTION, (Object)HttpHeaderValues.UPGRADE).set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY, (Object)key).set((CharSequence)HttpHeaderNames.HOST, (Object)WebSocketClientHandshaker13.websocketHostValue((URI)wsURL));
        if (!headers.contains((CharSequence)HttpHeaderNames.ORIGIN)) {
            headers.set((CharSequence)HttpHeaderNames.ORIGIN, (Object)WebSocketClientHandshaker13.websocketOriginValue((URI)wsURL));
        }
        ...
        headers.set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_VERSION, (Object)"13");
        return request;
    }
    ...
    protected WebSocketFrameDecoder newWebsocketDecoder() {
        return new WebSocket13FrameDecoder((boolean)false, (boolean)this.allowExtensions, (int)this.maxFramePayloadLength(), (boolean)this.allowMaskMismatch);
    }

    @Override
    protected WebSocketFrameEncoder newWebSocketEncoder() {
        return new WebSocket13FrameEncoder((boolean)this.performMasking);
    }
