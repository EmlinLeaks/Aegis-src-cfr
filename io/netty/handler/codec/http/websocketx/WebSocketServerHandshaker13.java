...
extends WebSocketServerHandshaker {
    ...
    public WebSocketServerHandshaker13(String webSocketURL, String subprotocols, WebSocketDecoderConfig decoderConfig) {
        super((WebSocketVersion)WebSocketVersion.V13, (String)webSocketURL, (String)subprotocols, (WebSocketDecoderConfig)decoderConfig);
    }
    ...
    protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug((String)"WebSocket version 13 server handshake key: {}, response: {}", (Object)key, (Object)accept);
        }
    ...
    protected WebSocketFrameDecoder newWebsocketDecoder() {
        return new WebSocket13FrameDecoder((WebSocketDecoderConfig)this.decoderConfig());
    }

    @Override
    protected WebSocketFrameEncoder newWebSocketEncoder() {
        return new WebSocket13FrameEncoder((boolean)false);
    }
}
