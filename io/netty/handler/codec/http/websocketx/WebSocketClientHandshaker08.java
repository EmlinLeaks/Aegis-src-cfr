...
extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker08(URI webSocketURL, WebSocketVersion version, String subprotocol, boolean allowExtensions, HttpHeaders customHeaders, int maxFramePayloadLength) {
        this((URI)webSocketURL, (WebSocketVersion)version, (String)subprotocol, (boolean)allowExtensions, (HttpHeaders)customHeaders, (int)maxFramePayloadLength, (boolean)true, (boolean)false, (long)10000L);
    }
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug((String)"WebSocket version 08 client handshake key: {}, expected response: {}", (Object)key, (Object)this.expectedChallengeResponseString);
        }
        ...
        headers.set((CharSequence)HttpHeaderNames.UPGRADE, (Object)HttpHeaderValues.WEBSOCKET).set((CharSequence)HttpHeaderNames.CONNECTION, (Object)HttpHeaderValues.UPGRADE).set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY, (Object)key).set((CharSequence)HttpHeaderNames.HOST, (Object)WebSocketClientHandshaker08.websocketHostValue((URI)wsURL));
        if (!headers.contains((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_ORIGIN)) {
            headers.set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_ORIGIN, (Object)WebSocketClientHandshaker08.websocketOriginValue((URI)wsURL));
        }
        ...
        headers.set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_VERSION, (Object)"8");
        return request;
    }
    ...
    protected WebSocketFrameDecoder newWebsocketDecoder() {
        return new WebSocket08FrameDecoder((boolean)false, (boolean)this.allowExtensions, (int)this.maxFramePayloadLength(), (boolean)this.allowMaskMismatch);
    }

    @Override
    protected WebSocketFrameEncoder newWebSocketEncoder() {
        return new WebSocket08FrameEncoder((boolean)this.performMasking);
    }
