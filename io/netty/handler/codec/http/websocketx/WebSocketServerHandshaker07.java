...
extends WebSocketServerHandshaker {
    ...
    public WebSocketServerHandshaker07(String webSocketURL, String subprotocols, WebSocketDecoderConfig decoderConfig) {
        super((WebSocketVersion)WebSocketVersion.V07, (String)webSocketURL, (String)subprotocols, (WebSocketDecoderConfig)decoderConfig);
    }
    ...
    protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug((String)"WebSocket version 07 server handshake key: {}, response: {}.", (Object)key, (Object)accept);
        }
    ...
    protected WebSocketFrameDecoder newWebsocketDecoder() {
        return new WebSocket07FrameDecoder((WebSocketDecoderConfig)this.decoderConfig());
    }

    @Override
    protected WebSocketFrameEncoder newWebSocketEncoder() {
        return new WebSocket07FrameEncoder((boolean)false);
    }
}
