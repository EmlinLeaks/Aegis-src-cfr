...
public final class ServerCookieEncoder {
    ...
    public static String encode(String name, String value) {
        return io.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode((String)name, (String)value);
    }
    ...
    public static List<String> encode(io.netty.handler.codec.http.Cookie ... cookies) {
        return io.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode((Cookie[])cookies);
    }
